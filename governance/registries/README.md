...
| `registry-contract-001` | Contract Registry | `shared` | `governance` | `canonical` | `active` | `repository-governance` | `1.9` | [Contract Registry](CONTRACT_REGISTRY.md) | `standard-registry-001` |
...
| `registry-principle-001` | Principle Registry | `shared` | `governance` | `canonical` | `active` | `repository-governance` | `1.2` | [Principle Registry](PRINCIPLE_REGISTRY.md) | `standard-registry-001` |
| `registry-publication-001` | Publication Registry | `shared` | `governance` | `canonical` | `active` | `repository-governance` | `2.4` | [Publication Registry](PUBLICATION_REGISTRY.md) | `standard-registry-001` |
| `registry-research-001` | Research Registry | `shared` | `governance` | `canonical` | `active` | `repository-governance` | `1.6` | [Research Registry](RESEARCH_REGISTRY.md) | `standard-registry-001` |
