...
| `registry-principle-001` | Principle Registry | `shared` | `governance` | `canonical` | `active` | `repository-governance` | `1.3` | [Principle Registry](PRINCIPLE_REGISTRY.md) | `standard-registry-001` |
...
| `registry-research-001` | Research Registry | `shared` | `governance` | `canonical` | `active` | `repository-governance` | `1.8` | [Research Registry](RESEARCH_REGISTRY.md) | `standard-registry-001` |
