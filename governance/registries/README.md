...
| `registry-publication-001` | Publication Registry | `shared` | `governance` | `canonical` | `active` | `repository-governance` | `1.9` | [Publication Registry](PUBLICATION_REGISTRY.md) | `standard-registry-001` |
