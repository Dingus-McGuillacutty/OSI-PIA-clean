...
| `publication-articles-index-001` | OSI-PIA Articles Index | `shared` | `publication` | `supporting` | `active` | `publication-stewardship` | `1.1` | [Articles](../../docs/publications/articles/index.md) | `standard-publication-001` |
