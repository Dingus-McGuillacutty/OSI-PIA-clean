...
| `publication-articles-index-001` | OSI-PIA Articles Index | `shared` | `publication` | `supporting` | `active` | `publication-stewardship` | `1.6` | [Articles](../../docs/publications/articles/index.md) | `standard-publication-001` |
...
| `publication-article-temporal-authority-001` | Temporal Authority | `shared` | `publication` | `supporting` | `active` | `publication-stewardship` | `0.2` | [Temporal Authority](../../docs/publications/articles/2026-09-16_temporal-authority.md) | `standard-publication-001` |
| `publication-article-capability-infrastructure-people-001` | Capability Infrastructure Should Belong to the People It Describes | `shared` | `publication` | `supporting` | `active` | `publication-stewardship` | `0.2` | [Capability Infrastructure Should Belong to the People It Describes](../../docs/publications/articles/2026-09-16_capability-infrastructure-belongs-to-people.md) | `standard-publication-001`<br>`principle-shared-human-centered-capability-infrastructure-001`<br>`research-pia-ler-open-skills-crosswalk-001` |
...
| `publication-project-bibliography-001` | OSI-PIA Project Bibliography | `shared` | `publication` | `supporting` | `active` | `publication-stewardship` | `0.3` | [Project Bibliography](../../docs/publications/PROJECT_BIBLIOGRAPHY.md) | `standard-publication-001` |
...
| `publication-project-status-001` | OSI-PIA Project Status | `shared` | `publication` | `supporting` | `active` | `repository-governance` | `0.5.3` | [Project Status](../../docs/PROJECT_STATUS.md) | `governance-model-001`<br>`architecture-pia-intake-subsystem-001`<br>`architecture-graph-platform-001` |
