...
| `publication-articles-index-001` | OSI-PIA Articles Index | `shared` | `publication` | `supporting` | `active` | `publication-stewardship` | `1.2` | [Articles](../../docs/publications/articles/index.md) | `standard-publication-001` |
