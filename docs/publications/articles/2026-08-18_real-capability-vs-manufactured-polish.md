...
In my article [“Hiring Does Not Have a Talent Problem. It Has a Translation Problem”](https://dingus-mcguillacutty.github.io/OSI-PIA-clean/publications/articles/2026-08-11_hiring-translation-problem.html), I argued that hiring systems often fail because real capability is poorly translated into standard hiring formats. In [“The False Negative Machine”](https://dingus-mcguillacutty.github.io/OSI-PIA-clean/publications/articles/2026-08-13_false-negative-machine.html), I argued that bad translations become dangerous when automated systems treat them as truth.

This article looks at the next failure mode: what happens when both sides of hiring optimize for AI-mediated systems, but the system becomes noisier instead of clearer.

Candidates are optimizing for the screen. Employers are optimizing for volume control. Vendors are optimizing for scalable workflows. The tools are supposed to make hiring faster, clearer, and more comprehensive. They are supposed to help employers understand candidates better and help candidates represent themselves more accurately.

But when all sides optimize for the interface, the result may be more volume, more polish, more filtering, more suspicion, and less confidence in what any given signal means.

That is the problem of manufactured polish. It is not only that weak candidates can look stronger. It is that the whole signal environment becomes less trustworthy.

## From Translation Failure to Signal Collapse

Article 1 focused on translation failure: real capability may not arrive in the format a hiring system expects. Article 2 focused on false negatives: real capability can be rejected because the representation fails. Article 3 focuses on the mirror-image problem: weak or unverified capability can advance because the representation succeeds.
...
The screening question changes from **“Does this look good?”** to **“What does this prove?”**
...
## AI Use Is Not the Same Thing as Deception
...
The problem begins when AI substitutes for evidence: when it invents experience, inflates claims, turns vague exposure into expertise, generates metrics the candidate cannot explain, or produces fluent answers that are not connected to the candidate’s actual judgment.

The ethical line is not “AI or no AI.” The ethical line is whether the representation remains accountable to reality.

AI can help a candidate tell the truth more clearly. It should not help them replace the truth with theater.

## Before Anyone Applies

Manufactured polish is not only a candidate-side phenomenon. Generative AI is changing hiring before an application ever arrives.

Forbes, drawing on London Business School research by Isabel Fernandez-Mateo, argues that generative AI is already shaping how jobs are defined, how candidates are attracted, how outreach is personalized, how applicant pools are formed, and how selection systems operate.[^forbes-lbs-genai-hiring]
...
## When Both Sides Adapt

The hiring process is becoming an arms race around representation.

Candidates learn that the system rewards keywords, tailored language, quantified claims, and polished stories. Employers learn that candidates can generate those signals at scale. Employers respond with more filters, screens, interviews, verification, or suspicion. Candidates respond with more tools, more applications, more tailoring, and more automation.

Neither side has to be malicious for the system to degrade. The candidate is trying to be seen. The employer is trying not to drown. The vendor is trying to make the process manageable. But when everyone optimizes locally, the shared signal environment can get worse.

Generative AI can homogenize candidate signals, lower screening accuracy, and make it harder for employers to distinguish between higher- and lower-quality applicants. It can also increase application volume, which increases the workload on hiring teams and may contribute to more rejection, more candidate frustration, and more process hardening.[^fernandez-mateo-jod]

That is why hiring can experience diminishing returns even while the tools become more powerful. The system produces more activity. It does not necessarily produce more understanding.
...
That does not excuse deception. But it explains the behavior.

The same tools that help an honest candidate clarify real evidence can also help another candidate manufacture evidence they cannot support. That is the unstable middle. The tool is not the whole issue. The relationship between representation and reality is the issue.
...
Professional Identity Architecture, or PIA, does not treat polish as proof. It treats polish as presentation.
...
Organizational Systems Intelligence, or OSI, looks at the system-level effect. When candidates can mass-produce polished applications and employers respond with more automated filtering, the hiring system may become more active without becoming more intelligent.

The organization receives more data, but not necessarily more evidence. It receives more applications, but not necessarily more understanding. It adds more screens, but not necessarily more judgment.

That is signal collapse. The system is producing movement, but not clarity.

OSI asks whether the organization is actually improving its ability to recognize capability, or merely increasing the amount of machinery between the person and the decision.
...
Hiring systems are mistaking representations of capability for knowledge of capability.

OSI-PIA begins from that distinction. Evidence is not interpretation. Interpretation is not proof. A proxy is not the person. A score is not judgment. A polished representation is not capability.
...
Together, they point toward a possible response to the failures described in this series: not faster guessing, not more polished theater, not more automated exclusion, but better evidence, clearer provenance, bounded interpretation, and human review.

## Better Evidence, Not More Suspicion
...
This article argues that polished translations create the opposite danger: representation can look stronger than the evidence beneath it.

That is the problem of manufactured polish.

The technology is supposed to clarify representation. But when candidates, employers, and vendors all optimize for the hiring interface, the system can produce more volume, more polish, and more filtering without producing better understanding.

The future of hiring should not be a contest between candidates using AI and employers detecting AI. It should be a better evidence system: one that helps people explain real capability clearly, helps organizations verify claims fairly, and treats polish as communication, not proof.

The next article in this series, **“Hidden Workers and Capability Leakage,”** turns from the hiring interface to the larger organizational problem: what happens when real capability exists but remains unseen, blocked, or undeployed.

## Sources

[^huang-ai-signal]: Mark Huang, “AI Broke the Hiring Signal,” June 21, 2026. Page states it is licensed CC BY-NC 4.0 and should be attributed to https://markhuang.ai/news/ai-broke-the-hiring-signal.  https://markhuang.ai/news/ai-broke-the-hiring-signal
...
https://www.forbes.com/sites/lbsbusinessstrategyreview/2026/03/16/generative-ai-is-changing-hiring-its-most-overlooked-impact-may-come-before-anyone-applies/

[^fernandez-mateo-jod]: Isabel Fernandez-Mateo, “How generative AI is transforming hiring in organizations: key issues and research questions,” Journal of Organization Design, 2026.  
https://link.springer.com/article/10.1007/s41469-025-00197-1