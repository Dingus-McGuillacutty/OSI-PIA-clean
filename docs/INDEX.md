...
This index is the front door to the OSI/PIA documentation system. It helps contributors locate foundational concepts, architectural decisions, research work, implementation guidance, and canonical project references.
...
13. [Canonical Terminology](../foundation/CANONICAL_TERMINOLOGY.md)
14. [Project Vocabulary](history/PROJECT_VOCABULARY.md)
15. [Knowledge Lifecycle](../foundation/KNOWLEDGE_LIFECYCLE.md)
16. [Knowledge Management Governance](architecture/KNOWLEDGE_MANAGEMENT_GOVERNANCE.md)
17. [Congruence Protocol](../governance/CONGRUENCE_PROTOCOL_WORKING.md)
18. [Assurance Architecture](architecture/Assurance_Architecture.md)
19. [Concept Map](CONCEPT_MAP.md)
20. [Ontology Meta-Model](../ontology/META_ONTOLOGY.md)
21. [Graph Architecture](../architecture/graph_ontology/Graph_Architecture.md)
22. [Graph Ontology Crosswalk](../architecture/graph_ontology/graph_Ontology.md)
23. [Graph Standards](../architecture/graph_standards/Graph_Standards.md)

## Documentation Domains

### Architecture

Stable system design, structural relationships, component boundaries, and cross-cutting operating mechanisms.

### Research

Exploration, hypotheses, evidence gathering, working models, and material not yet promoted into stable architecture.

### Principles

Foundational commitments that guide architecture, implementation, governance, and interpretation.
...
Cross-cutting structures governing how knowledge matures and is maintained:
...
Implementation-specific contracts, interfaces, behaviors, and technical guidance.
...
- **Research** is for exploration.
- **Architecture** is for stable design.
- **Components** describe implementation.
- **ADRs** preserve decision rationale.
- **History** preserves architectural evolution.

Knowledge should move from research into architecture only after sufficient formulation, congruence review, validation, and justified promotion.

## Maintenance

Update this index whenever a new canonical project document is added, moved, superseded, or retired.
