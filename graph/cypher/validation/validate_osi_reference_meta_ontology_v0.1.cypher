// Validate the OSI Reference meta-ontology registry v0.1.
...
CALL (ontology) {
  MATCH (ontology)-[:USES_CONFIDENCE_MODEL]->(model:ConfidenceModel)
...
CALL () {
  ...
  WHERE name IN [
    'osi_meta_ontology_id_unique',
    'osi_meta_concept_id_unique',
    'osi_meta_relationship_definition_id_unique',
    'osi_meta_lifecycle_state_id_unique',
    'osi_meta_knowledge_state_id_unique',
    'osi_meta_confidence_model_id_unique'
  ]
